...
public class AjouterTP extends JFrame implements ActionListener {
    ...
    public AjouterTP(Recherche service){
        ...
        idModule = new JComboBox<Object>((Object[])service.getIdModule().toArray());
         
        JLabel enseignant = new JLabel("Enseignant");
        idEnseignant = new JComboBox<Object>((Object[])service.getIdEnseignant().toArray());
        
        JLabel salle = new JLabel("Salle");
        idSalle = new JComboBox<Object>((Object[])service.getIdSalle().toArray());
    ...
    public void actionPerformed(ActionEvent e){
    	...
    	if (source==enregistrer){
			try{
				TP tp = new TP();
				tp.setIdModule(idModule.getSelectedItem().toString());
				tp.setIdSalle(Integer.parseInt (idSalle.getSelectedItem().toString()));
				tp.setIdEnseignant(Integer.parseInt (idEnseignant.getSelectedItem().toString()));
				tp.setIdSection(Integer.parseInt (idSection.getSelectedItem().toString()));
				tp.setIdGroupe(Integer.parseInt (idGroupe.getSelectedItem().toString()));
