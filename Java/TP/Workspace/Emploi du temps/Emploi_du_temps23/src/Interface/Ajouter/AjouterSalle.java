...
public class AjouterSalle extends JFrame implements ActionListener {
    ...
    public AjouterSalle() throws Exception{
        ...
        predecesseur.setSelectedIndex(0);
    ...
    public void actionPerformed(ActionEvent e){
    	...
    	if (source==enregistrer){
			try{
				...
				salle.setIdBatiment(BatimentDAO.getInstance().getById((Integer)idBatiment.getSelectedItem()));
				salle.setSuccesseur(SalleDAO.getInstance().getById((Integer)successeur.getSelectedItem()));
				salle.setPredecesseur(SalleDAO.getInstance().getById((Integer)predecesseur.getSelectedItem()));
