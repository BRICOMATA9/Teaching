...
public class AjouterTP extends JFrame implements ActionListener {
    ...
    public AjouterTP(){
		...
		setTitle("Ajouter un TP");
		setBounds(200, 200,360, 390);
		setVisible(true);
		
        JLabel module = new JLabel("Module");
        idModule = new JComboBox<Object>((Object[])ModuleDAO.getInstance().getIdModule().toArray());
         
        JLabel enseignant = new JLabel("Enseignant");
        idEnseignant = new JComboBox<Object>((Object[])EnseignantDAO.getInstance().getIdEnseignant().toArray());
        ...
        idGroupe = new JComboBox<Object>((Object[])GroupeDAO.getInstance().getIdGroupe().toArray());
        ...
        idSection = new JComboBox<Object>((Object[])SectionDAO.getInstance().getIdSection().toArray());
        ...
        add(heureDebut,gbc,jp,1,6,1,1);
        add(durree,gbc,jp,1,7,1,1);
        ...
        add(heure,gbc,jp,0,6,1,1);
        add(durree_,gbc,jp,0,7,1,1);
    ...
    public void actionPerformed(ActionEvent e){
    	...
    	if (source==enregistrer){
			try{
				TP tp = new TP();
				tp.setIdModule(ModuleDAO.getInstance().getModuleById(idModule.getSelectedItem().toString()));
				tp.setIdSalle(SalleDAO.getInstance().getSalleById(Integer.parseInt (idSalle.getSelectedItem().toString())));
				tp.setIdEnseignant(EnseignantDAO.getInstance().getEnseignantById(Integer.parseInt (idEnseignant.getSelectedItem().toString())));
				tp.setIdSection(SectionDAO.getInstance().getSectionById(Integer.parseInt (idSection.getSelectedItem().toString())));
				tp.setIdGroupe(GroupeDAO.getInstance().getGroupeById(Integer.parseInt (idGroupe.getSelectedItem().toString())));
