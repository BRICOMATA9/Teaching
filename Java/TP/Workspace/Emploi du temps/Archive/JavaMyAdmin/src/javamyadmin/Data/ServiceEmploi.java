...
public class ServiceEmploi {
	...
	public ServiceEmploi(JFrame frame) {
...
/*#####################################################################################################################################*/
	...
	public List<EmploiDuTemps> findAllEmploi(){
		List<EmploiDuTemps> listEmploi = new ArrayList<EmploiDuTemps>();
		try{
			String[] table = { "Emploi" };
			String[] fields = { "id_emploi, id_classe" };
			String condition = "";
	...
	public List<Sceance> findAllSceance() {
...
/*################################################################################################################*/
	...
	public void addPromotion(Promotion promotion) throws Exception {
		String table = "Promotion";
		String[] fields = { "id_promo, name_promo, year" };
		String[] value = { promotion.getId(), promotion.getName(), new Integer(promotion.getYear()).toString()};
	...
	public void deletePromotion(Promotion promotion) throws Exception {
		String table = "Promotion";
		String condition = "id_promo = '" + promotion.getId() + "'";
	...
	public void UpdatePromotion(Promotion promotion) throws Exception {
		String table = "Promotion";
		String[] fields = { "name_promo, year" };
		String[] value = { promotion.getName(), new Integer(promotion.getYear()).toString()};
		String condition = "id_promo = '" + promotion.getId() + "'";
	...
	public void addClasse(Classe classe) throws Exception {
		String table = "Classe" ;
		String[] fields = { "id_classe,id_promo,name_classe" };
		String[] value = { classe.getId(), classe.getIdPromotion(), classe.getName()};
		String t = queryString.Query_Insert(table, fields, value);
		if (process.Execute_DB(conn, t))
			System.out.println("Ok!");
	}

	public void deleteClasse(Classe classe) throws Exception {
		String table = "Classe";
		String condition = "id_classe = '" + classe.getId() + "'";
		String t = queryString.Query_Delete(table, condition);
		System.out.println(t);
		if (process.Execute_DB(conn, t))
			System.out.println("Ok!");
	...
	public void UpdateClasse(Classe classe) throws Exception {
		String table = "Classe" ;
		String[] fields = { "id_promo,name_classe" };
		String[] value = { classe.getIdPromotion(), classe.getName()};
		String condition = "id_classe = '" + classe.getId() + "'";
		String t = queryString.Query_Update(table, fields, value, condition);
		if (process.Execute_DB(conn, t))
			System.out.println("Ok!");
	...
	public void updateEmploi(EmploiDuTemps emploi) throws Exception {
		String table = "Emploi";
		String[] fields = {"id_classe", };
		String[] value = { emploi.getClasse() };
		String condition = "id_emploi = '" + emploi.getId() + "'";
		String t = queryString.Query_Update(table, fields, value, condition);
		if (process.Execute_DB(conn, t))
			System.out.println("Ok!");
	}
	...
	public void updateModule(Module module) throws Exception {
		...
		Query queryString = new Query();
		String table = "Module";
		String[] fields = { "id_prof", "name_module", "duree" };
		String[] value = { module.getIdProfessor(),
				module.getName(), Integer.toString(module.getDuree()) };
		String condition = "id_module= '" + module.getId() + "'";
		String t = queryString.Query_Update(table, fields, value,condition);
		if (process.Execute_DB(conn, t))
			System.out.println("Ok!");
	}
	...
	public void deleteProfessor(Professor professor) throws Exception {
		...
		String conditionE = "id_prof= '" + professor.getId() + "'";
		String tE = queryString.Query_Delete(tableE, conditionE);
		if (process.Execute_DB(conn, tE))
			System.out.println("Ok!");
	}
	...
	public void updateProfessor(Professor professor) throws Exception {
		...
		String[] value = { 
				...
				professor.getLastName(), 
				professor.getEmail() };
		String condition = "id_prof= '" + professor.getId() + "'";
		String t = queryString.Query_Update(table, fields, value, condition);
		if (process.Execute_DB(conn, t))
			System.out.println("Ok!");
	}
