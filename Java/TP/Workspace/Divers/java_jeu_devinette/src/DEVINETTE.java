...
public class DEVINETTE  
{
 ...
 public void go(int num ){
  if (num<val){ 
   JOptionPane.showMessageDialog(null,"trop petit!");nb++;
  }
  if (num>val){ 
   JOptionPane.showMessageDialog(null,"trop grand!");nb++;
  }
  ...
  if ((nb >= 7)&& (num!=val)){
   JOptionPane.showMessageDialog(null,"GAME OVER VOUS AVEZ PERDUS!");
   if(JOptionPane.showConfirmDialog(null, "Rejouer","Rejouer",0)==1)System.exit(0);		 
    else nb=0;
  }
 }
