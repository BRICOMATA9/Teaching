...
public class HttpUtilities {
    ...
    public static void sendBytes( SocketChannel socket, File file, ByteBuffer buffer ) throws IOException {
    ...
    public static void sendTextFile ( SocketChannel socket, File file, String request ) throws Exception {
        String fileString = "";
