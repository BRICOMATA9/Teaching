<!-- gestion du profil vendeur avec la base de données -->
<?php 
session_start();
  ...
  <header>
    ...
    <section class="jumbotron text-center">
      ...
      <div class="py-5 text-center text-info">
        <h2>Votre Profil</h2>
        <p class="lead">Vous êtes vendeur sur A MA ZONE ? Vous pouvez mettre en vente un ou plusieurs articles !</p>
      </div>
    </section>

    <div class="container">
      <!-- Affichage du profil du vendeur -->
      <div class="row"> 
        <div class="col-md-8">
          <h4>Votre profil</h4>
      ...
      <div class="row">
        ...
        <div class="col-md-5">
          <div class="card mb-4 shadow-sm">
            ...
            <div class="card-body">
              <p class="card-text"> Voir tous vos articles en vente</p> <!-- bouton pour voir tous les articles mis en vente par le vendeur -->
        ...
        <div class="col-md-5">
          <div class="card mb-4 shadow-sm">
            ...
            <div class="card-body">
              <p class="card-text"> Ajouter un ou plusieurs articles</p><!-- bouton pour ajouter un ou plusieurs articles en vente -->
              <div class="d-flex justify-content-between align-items-center">
              </div>
            </div>
          </div>
