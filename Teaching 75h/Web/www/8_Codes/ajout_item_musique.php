...
<?php
    ...
    if (isset($_POST['button_ajout'])) {
        ...
        else if((!empty($nom)) AND (!empty($artiste)) AND (!empty($annee_sortie)) AND (!empty($description)) AND (!empty($photos)) AND (!empty($prix)) AND (!empty($stock))){

            if ($db_found) {
                
                //recherche parmis les musiques si ce nom exite déjà 
                ...
                if (mysqli_num_rows($result) == 0) {
                    ...
                    $sql = "SELECT * FROM musique WHERE description = '$description'";
                    $result = mysqli_query($db_handle, $sql);
                    //si pas de résultat
                    if (mysqli_num_rows($result) == 0) {
                        ...
                        $sql = "INSERT INTO musique(ID_vendeur,nom,artiste,annee_sortie,genre,photos,photo2,description,video,prix,stock,nb_vendus,date_ligne) VALUES ('$ID_vendeur','$nom','$artiste','$annee_sortie','$genre','$photos','$photo2','$description','$video','$prix','$stock',0,NOW())";
                        $result = mysqli_query($db_handle, $sql);  

                        $valid = "Votre musique ". $nom ." a été ajoutée à la vente !";
...
<head>
    ...
    <title>Ajout Musique | ECE Amazon</title>
    <meta charset="utf-8">
...
<body>
   <!-- BARRE DE NAVIGATION A CONSERVER POUR CHAQUE PAGE -->
    ...
    <header>
        <div class="container">
            <!-- Titre -->
            <h2 class="titre">Mettre en vente une musique</h2>
                    ...
                    <form method="post">
                        <table>
                            ...
                            <tr>
                                ...
                                <td><input type="Date" name="annee_sortie"></td>
                            </tr>
                            <tr>
                                <td>Genre: </td>
                                <td>
                            ...
                            <tr>
                                <td>Nom photo pochette d'album: </td>
