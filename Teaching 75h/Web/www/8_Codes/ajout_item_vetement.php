...
<?php
    ...
    if (isset($_POST['button_ajout'])) {
        ...
        else if((!empty($nom)) AND (!empty($taille)) AND (!empty($modele)) AND (!empty($description)) AND (!empty($photos)) AND (!empty($prix)) AND (!empty($stock))){
            ...
            if ($db_found) {
                ...
                if (mysqli_num_rows($result) == 0) {
                    ...
                    if (mysqli_num_rows($result) == 0) {
                        ...
                        //insertion du nouveau vêtement
                        $sql = "INSERT INTO vetements(ID_vendeur, nom,couleur,taille,genre,type,modele,matiere,photos,photo2,description,video,prix,stock,nb_vendus,date_ligne) VALUES ('$ID_vendeur','$nom','$couleur','$taille','$genre','$type','$modele','$matiere','$photos','$photo2','$description','$video','$prix','$stock',0,NOW())";
                        $result = mysqli_query($db_handle, $sql);  

                        $valid = "Votre vêtement ". $nom ." a été ajouté à la vente !";
...
<head>
    ...
    <title>Ajout Vêtement | ECE Amazon</title>
    <meta charset="utf-8">
...
<body>
    ...
    <header>
        <div class="container">
            <!-- Titre -->
            <h2 class="titre">Mettre en vente un vêtement</h2>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="matiere">
                                        ...
                                        <option value="fausse fourrure">Fausse fourrure</option>
