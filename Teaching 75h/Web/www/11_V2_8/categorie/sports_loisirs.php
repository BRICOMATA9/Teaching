...
<body>
	<main role="main">
		...
		<div class="jumbotron">
			<div class="container">
			  <h1 class="display-3">Sport et Loisirs</h1>
			  <p>Achetez vos articles de Sports et Loisirs parmi plus d'1 million d'articles : yoga, fitness, rando, cyclisme, pêche, course, nautique, golf, football... <br>Dans cette e-boutique, nous nous efforçons de vous proposer les meilleurs articles aux meilleurs prix ! </p>
			</div>
		</div>
		...
		<div class="container">
			...
			<div id="all_blocks">
				...
				$reponse = $bdd->query('SELECT * FROM items INNER JOIN sports_hobbies ON items.id=sports_hobbies.id_item');	
					...
					<div class="col-md-4" id="itemAff">
						<p>
							<div id="block_titre" class = "container">
								<h4><?php echo subMyString( $donnees['name'], 50, '...'); ?></h4>
							</div>
							...
							<div id="block_bouton" class = "container">
								<a class="btn btn-warning" id="bouton_annonce" href="../Article/pageArticleSports.php?id=<?php echo $donnees['id'] ?>" role="button">Voir l'offre &raquo;</a>
							</div>
						</p>
					</div>
