...
<main role="main">
	...
	<!-- A LIRE !!!!!!!!! https://openclassrooms.com/fr/courses/918836-concevez-votre-site-web-avec-php-et-mysql/914293-lisez-des-donnees -->
			...
			<?php
				...
				$reponse = $bdd->query('SELECT * FROM items INNER JOIN books ON items.id=books.id_item WHERE id='.$_GET['id']);
			...
			?>
				...
				<div id="pageArticle">
						...
						<div id="bouton_retour" class = "container">
							<a class="btn btn-link" id="bouton_retour" href="../categorie/livres.php" role="button"><< Retour page Livres</a>
						</div>
