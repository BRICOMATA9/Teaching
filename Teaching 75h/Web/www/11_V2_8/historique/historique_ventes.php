...
<div class="jumbotron">
	<div class="container">
		<h1 class="display-3">Historique de vos ventes</h1>
	</div>
</div>
...
<div class="container-fluid" id="block_info">
	...
	$reponse = $bdd->query('SELECT * FROM salesHistory WHERE seller="'.$_SESSION['email'].'"');
	?>
			...
			while ($donnees = $reponse->fetch())
				{
					?>
					<tr>
						<th scope="row"><?php echo $donnees['id_item'];?></th>
						<td><?php echo subMyString($donnees['productName'], 40);?></td>
