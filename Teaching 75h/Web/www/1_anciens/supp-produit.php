	...
	<section class="bg0 p-t-104 p-b-116">
		...
		// identifier la BDD
			...
			$email = isset($_POST["email"])?$_POST["email"] : "";
 			...
 			if($photo == "") {$erreur .= "Le champ Nom de produit est vide. <br>";}
 			
 			if($nom == "") {$erreur .= "Le champ Photo est vide. <br>";}
 				...
 				if ($_POST["button2"])
 			{
 				if($db_found) {
 					...
 					$result = mysqli_query($db_handle, "DELETE FROM items WHERE photo='$photo' AND nom ='$nom' ");
 					echo "Votre produit était bien supprimé." . "<br>";
 				}
 			}
