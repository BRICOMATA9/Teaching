		...
		//recuperer les donnees venant de la page HTML
 				...
 				if ($_POST["button2"])
 			{
 				if($db_found){
 					...
 					$result = mysqli_query($db_handle, "SELECT * FROM acheteur WHERE Email LIKE '%$email%'");

 					$rows = mysqli_num_rows($result);
						//regarder s'il y a de résultat
 							echo $rows;
 					while ($data = mysqli_fetch_assoc($result)){
						echo "Bienvenu, Vos informations sont :" . "<br>";
						echo "Nom: " . $data['nom'] . "<br>";
						echo "Prenom: " . $data['prenom'] . "<br>";
						echo "E-mail: " . $data['Email'] . "<br>";
						echo "Votre Numero de carte: " . $data['numero_carte'] . "<br>";
 			...
 			{
 				echo "Erreur : $erreur";
 				echo "Vous devez vous inscrire. <br>";
 			}
			...
			<div class="flex-w flex-tr">
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
					<form action="confirmation.php" method="post">
						...
						<div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="adresse1" placeholder="Adresse Ligne 1">
							
						</div>

						<div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="adresse2" placeholder="Adresse ligne2">
							
						</div>

						<div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="Ville" placeholder="Ville">
							
						</div>

						<div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="code" placeholder="Code Postale">
							
						</div>

						<div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="num" placeholder="Numéro de telephone">
						...
						<div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="numc" placeholder="Numéro de la carte">
							
						</div>
						<div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="holder" placeholder="Nom afiché dans la carte">
						</div>

						<div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="date" placeholder="Date d’expiration de la carte">
						
						</div>

						<div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="codesecu" placeholder="Code de sécurité (3 ou 4 chiffres, selon la carte)">
						</div>


						<input class="flex-c-m stext-101 cl0 size-121 bg3 bor1 hov-btn3 p-lr-15 trans-04 pointer" name="payer" type="submit" value="Payer" />
					</form>
				</div>
