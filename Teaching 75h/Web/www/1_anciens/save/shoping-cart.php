						...
						<ul class="main-menu">
							...
							<li>
								...
								<ul class="sub-menu">
									...
									<li><a href='music.html'>Musiques</a></li>
									<li><a href='#'>Vêtements</a>
										<ul class="sub-menu">
											<li><a href='vfemme.html'>Femmes</a></li>
											<li><a href='vhommes.html'>Hommes</a></li>
										</ul>
									</li>
									<li><a href='sport.html'>Sport & Loisir</a></li>
								</ul>
							</li>
											...
											for ($i=0 ;$i < $nbArticles ; $i++)
												{
													...
													echo "<td><a href=\"".htmlspecialchars("shoping-cart.php?action=suppression&l=".rawurlencode($_SESSION['panier']['libelleProduit'][$i]))."\">XX</a></td>";
													echo "</tr>";
