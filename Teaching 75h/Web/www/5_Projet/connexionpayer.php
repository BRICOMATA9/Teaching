...
if(isset($_POST['seconnecter']))
{
   if(!empty($pseudoconnexion) AND !empty($passwconnexion))
   {
      ...
      if($compteexiste == 1) {
         ...
         header("Location: moyenpaiement.php?id=".$_SESSION['id']);
      } else {
  ...
  <div id="section">
    <div align="center">
      ...
      <form method="POST" action="">
        <input type="text" name="pseudoconnexion" placeholder="Pseudonyme" />
        <input type="password" name="passwconnexion" placeholder="Mot de passe" />
        <br /><br />
