...
public class AfficherSalleByType <T> extends JFrame implements ActionListener {
    ...
    public AfficherSalleByType() throws Exception{
        ...
        supprimer = new JComboBox<Object>(typ);
	    ...
	    Stream<Salle> liste = SalleDAO.getInstance().getByType((String)supprimer.getSelectedItem());
