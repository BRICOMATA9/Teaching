...
public class TestsAVerifier extends junit.framework.TestCase{
	...
	public void testUneAddition1(){
		Expression expr = new Addition(new Variable(m,"i",3), new Variable(m,"i",4));
	  assertEquals(" 3+2 != 5 ?, curieux ",8,expr.accepter(ve).intValue());//hhh il a écrasé le 3 puisque c la meme i
	 }
