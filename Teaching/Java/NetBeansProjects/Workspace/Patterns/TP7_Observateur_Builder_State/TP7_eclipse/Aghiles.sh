...
javadoc -encoding Cp1252 -cp ./lib/junit-4.11.jar -docletpath ~/Téléchargements/UmlGraph.jar -doclet org.umlgraph.doclet.UmlGraph -package -attributes src/builder/*.java
