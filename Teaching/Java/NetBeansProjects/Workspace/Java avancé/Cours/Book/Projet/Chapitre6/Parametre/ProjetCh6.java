...
#	Section  : Projet - Le passage de paramètres par valeur
...
public class ProjetCh6{ 
  	...
  	switch (choix){
  		...
  		case 2 :
  			...
  			if (numéroLu == numéroCpte)  
  			 afficherCpte( numéroCpte,  typeCpte, taux,  val_courante);
  			else
 ...
 // Affiche le compte dont les données sont passées en paramètre
