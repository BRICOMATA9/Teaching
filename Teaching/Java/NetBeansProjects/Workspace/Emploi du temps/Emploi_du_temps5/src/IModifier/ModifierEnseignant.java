...
public class ModifierEnseignant extends JFrame implements ActionListener {
    ...
    public ModifierEnseignant(){
        ...
        idPersonne = new JComboBox<Object>((Object[])EnseignantDAO.getInstance().getIdEnseignant().toArray());
    ...
    public void actionPerformed(ActionEvent e){
    	...
    	if (source==idPersonne){
    		Enseignant enseignant = EnseignantDAO.getInstance().getEnseignantById(Integer.parseInt (idPersonne.getSelectedItem().toString()));
			...
			try{
				...
				EnseignantDAO.getInstance().modifierEnseignant(prof);
				setVisible(false);
			}catch(Exception eh){
