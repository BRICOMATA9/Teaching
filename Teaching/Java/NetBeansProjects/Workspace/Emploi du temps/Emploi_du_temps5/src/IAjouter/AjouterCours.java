    ...
    public void actionPerformed(ActionEvent e){
    	...
    	if (source==enregistrer){
			try{
				...
				cours.setIdModule(ModuleDAO.getInstance().getModuleById(idModule.getSelectedItem().toString()));
				cours.setIdSalle(SalleDAO.getInstance().getSalleById(Integer.parseInt (idSalle.getSelectedItem().toString())));
				cours.setIdEnseignant(EnseignantDAO.getInstance().getEnseignantById(Integer.parseInt (idEnseignant.getSelectedItem().toString())));
				cours.setIdSection(SectionDAO.getInstance().getSectionById(Integer.parseInt (idSection.getSelectedItem().toString())));
