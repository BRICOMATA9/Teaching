...
public class ModifierEtudiant extends JFrame implements ActionListener {
    ...
    public ModifierEtudiant() throws Exception{
        ...
        idPersonne = new JComboBox<Object>((Object[])EtudiantDAO.getInstance().getId().toArray());
    ...
    public void actionPerformed(ActionEvent e){
		...
		try{
	    	if (source==idPersonne){
	    		Etudiant etudiant = EtudiantDAO.getInstance().getById(Integer.parseInt (idPersonne.getSelectedItem().toString()));
				...
				etudiant.setIdGroupe(GroupeDAO.getInstance().getById(Integer.parseInt (idGroupe.getSelectedItem().toString())));
