...
public class TraitementCours extends JFrame implements ActionListener {
    ...
    public TraitementCours(String s,Function<Cours> f) throws Exception{
		...
		//dateDebut.actionPerformed(arg0);
