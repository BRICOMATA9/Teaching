...
public class ModifierEtudiant extends JFrame implements ActionListener {
    ...
    public ModifierEtudiant(Recherche service){
        ...
        idPersonne = new JComboBox(service.getIdEtudiant().toArray());
        ...
        JLabel groupe = new JLabel("Groupe");service.getAllGroupe().toArray();
        idGroupe = new JComboBox(service.getIdGroupe().toArray());
    ...
    public void actionPerformed(ActionEvent e){
    	...
    	if (source==idPersonne){
    		Etudiant etudiant = service.getEtudiantById(Integer.parseInt (idPersonne.getSelectedItem().toString()));
			...
			try{
				...
				etudiant.setIdGroupe(Integer.parseInt (idGroupe.getSelectedItem().toString()));
