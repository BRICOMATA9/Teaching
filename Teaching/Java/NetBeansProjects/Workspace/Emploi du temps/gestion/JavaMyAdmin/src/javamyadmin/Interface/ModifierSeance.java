...
public class ModifierSeance extends JFrame implements ActionListener {
    ...
    public ModifierSeance(ServiceEmploi service){
        
				this.service=service;

        JLabel seance = new JLabel("seance");
				String vmodule[] = {"module1","module2"};
        id_sceance = new JComboBox(vmodule); 
    ...
    public void actionPerformed(ActionEvent e){
    	Object source = e.getSource();
			if (source==id_sceance){
					Sceance sceance = service.findSceanceById((String)id_sceance.getSelectedItem());
					id_emploi.getSelectedItem();
					sceance.setModule(module);
					ChoixDate.getDate();
					time_sceance.getSelectedItem();				
				...
				try{
					...
					sceance.setId((String)id_sceance.getSelectedItem());
