...
public class ModifierSalle extends JFrame implements ActionListener {
    ...
    public ModifierSalle(Recherche service){
        ...
        idBatiment = new JComboBox<Object>((Object[])service.getIdBatiment().toArray());
    ...
    public void actionPerformed(ActionEvent e){
    	...
    	if (source==enregistrer){
			try{
				...
				salle.setIdBatiment((Integer)idBatiment.getSelectedItem());
				service.modifierSalle(salle);
				setVisible(false);
			}catch(Exception eh){
