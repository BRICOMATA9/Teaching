...
public class ModifierModule extends JFrame implements ActionListener {
    ...
    public ModifierModule(Recherche service){
        
		this.service=service;
		setTitle("Modifier un Module");
    ...
    public void actionPerformed(ActionEvent e){
    	...
    	if (source==enregistrer){
			try{
				...
				module.setIdModule(idModule.getSelectedItem().toString());
				module.setNom(nom.getText().trim());
				module.setCoefficient(Integer.parseInt(coef.getText()));
				service.modifierModule(module);
				setVisible(false);
			}catch(Exception eh){
