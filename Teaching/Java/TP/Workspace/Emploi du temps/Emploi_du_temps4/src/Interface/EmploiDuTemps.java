...
import bdd.Section;
import bdd.TP;
import modifier.ModifierEnseignant;
import modifier.ModifierEtudiant;
import modifier.ModifierGroupe;
import modifier.ModifierModule;
import modifier.ModifierSalle;
import modifier.ModifierSeance;
import modifier.ModifierSection;
import sql.DB;
...
/*			else if (e.getSource()==button3)
			...
			if (e.getSource()==enseignant0)
				new Afficher<Enseignant>("Enseignant",service.getAllEnseignant());
			else if (e.getSource()==etudiant0)
					new Afficher<Etudiant>("Etudiant",service.getAllEtudiant());
			else if (e.getSource()==groupe0)
				new Afficher<Groupe>("Groupe",service.getAllGroupe());
			else if (e.getSource()==matiere0)
				new Afficher<Module>("Module",service.getAllModule());
			else if (e.getSource()==promotion0)
				new Afficher<Section>("Section",service.getAllSection());
			else if (e.getSource()==seance0)
				new Afficher<Cours>("Cours",service.getAllCours());
			else if (e.getSource()==tp0)
				new Afficher<TP>("TP",service.getAllTP());
			else if (e.getSource()==batiment0)
				new Afficher<Batiment>("Batiment",service.getAllBatiment());
			else if (e.getSource()==salle0)
				new Afficher<Salle>("Batiment",service.getAllSalle());
			...
			if (e.getSource()==enseignant1)
				...
				new AjouterCours(service);
			else if (e.getSource()==tp1)
				new AjouterTP(service);
				...
				new Supprimer<Enseignant> (service,() -> service.getAllEnseignant());
			else if (e.getSource()==etudiant2)
				new Supprimer<Etudiant> (service,() -> service.getAllEtudiant());
			else if (e.getSource()==groupe2)
				new Supprimer<Groupe> (service,() -> service.getAllGroupe());
			else if (e.getSource()==matiere2)
				new Supprimer<Module> (service,() -> service.getAllModule());
			else if (e.getSource()==promotion2)
				new Supprimer<Section> (service,() -> service.getAllSection());
			else if (e.getSource()==salle2)
				new Supprimer<Salle> (service,() -> service.getAllSalle());
			else if (e.getSource()==batiment2)
				new Supprimer<Batiment> (service,() -> service.getAllBatiment());
			else if (e.getSource()==seance2)
				new Supprimer<Cours>(service,() -> service.getAllCours());
			else if (e.getSource()==tp2)
				new Supprimer<TP>(service,() -> service.getAllTP());

			else if (e.getSource()==enseignant3)
				new ModifierEnseignant(service);
			else if (e.getSource()==etudiant3)
				new ModifierEtudiant(service);
			else if (e.getSource()==groupe3)
				new ModifierGroupe(service);
			else if (e.getSource()==matiere3)
				new ModifierModule(service);
			else if (e.getSource()==promotion3)
				new ModifierSection(service);
			else if (e.getSource()==seance3)
				new ModifierSeance<Cours>(service,() -> service.getAllCours());
			else if (e.getSource()==tp3)
				new ModifierSeance<TP>(service,() -> service.getAllTP());
			else if (e.getSource()==salle3)
				new ModifierSalle(service);
