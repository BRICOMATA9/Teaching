...
public class ModifierClasse extends JFrame implements ActionListener {
  ...
  public ModifierClasse(ServiceEmploi service){
      ...
      id_classe = new JComboBox(vpromo);
  ...
  public void actionPerformed(ActionEvent e){
  	...
  	if (source==enregistrer){
			...
			classe.setId((String)id_classe.getSelectedItem());
