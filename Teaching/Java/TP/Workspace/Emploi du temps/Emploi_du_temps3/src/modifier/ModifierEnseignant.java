...
public class ModifierEnseignant extends JFrame implements ActionListener {
    ...
    public ModifierEnseignant(Recherche service){
        ...
        idPersonne = new JComboBox(service.getIdEnseignant().toArray());
    ...
    public void actionPerformed(ActionEvent e){
    	...
    	if (source==idPersonne){
    		Enseignant enseignant = service.getEnseignantById(Integer.parseInt (idPersonne.getSelectedItem().toString()));
			...
			try{
				...
				service.modifierEnseignant(prof);
				setVisible(false);
			}catch(Exception eh){
