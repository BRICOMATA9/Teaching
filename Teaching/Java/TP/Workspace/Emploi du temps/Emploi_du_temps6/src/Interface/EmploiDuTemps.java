...
import Interface.Modifier.ModifierSeance;
...
/*			else if (e.getSource()==button3)
			...
			if (e.getSource()==enseignant0)
				...
				new Afficher<Salle>("Batiment",SalleDAO.getInstance().getAll());
			...
			if (e.getSource()==enseignant1)
				...
				new Supprimer<Cours>(() -> CoursDAO.getInstance().getAll());
			else if (e.getSource()==tp2)
				new Supprimer<TP>(() -> TPDAO.getInstance().getAll());
				...
				new ModifierSeance<Cours>(() -> CoursDAO.getInstance().getAll());
			else if (e.getSource()==tp3)
				new ModifierSeance<TP>(() -> TPDAO.getInstance().getAll());
