    ...
    public void actionPerformed(ActionEvent e){
    	...
    	if (source==enregistrer){
			try{
				...
				tp.setIdSalle(SalleDAO.getInstance().getById(Integer.parseInt (idSalle.getSelectedItem().toString())));
				tp.setIdEnseignant(EnseignantDAO.getInstance().getById(Integer.parseInt (idEnseignant.getSelectedItem().toString())));
				tp.setIdSection(SectionDAO.getInstance().getById(Integer.parseInt (idSection.getSelectedItem().toString())));
				tp.setIdGroupe(GroupeDAO.getInstance().getById(Integer.parseInt (idGroupe.getSelectedItem().toString())));
