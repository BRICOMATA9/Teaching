...
public class Cours {
	...
	public String toString() {
		return "Module=" + idModule + ", Salle=" + idSalle + ", Enseignant=" + idEnseignant
				+ ", dateDebut=" + formatterDate.format(dateDebut) + ", heureDebut=" + formatterTime.format(heureDebut) + ", duree=" + formatterTime.format(duree) + ", Section="
				+ idSection;
	}
