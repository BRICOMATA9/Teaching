...
<body><center>
<jsp:useBean id="emploiDetails" class="Model.EmploiDuTemps" />
<jsp:setProperty 
    name="emploiDetails" 
    property="id"
    value='<%= request.getParameter("idEmploi") %>' />
...
emploi = service.findEmploiById(emploiDetails.getId());
Calendar cal = Calendar.getInstance();
Date date = new Date();
cal.setTime(date);
String WEEK=request.getParameter("idWeek");
int WEEK_OF_YEAR = Integer.parseInt(WEEK);
