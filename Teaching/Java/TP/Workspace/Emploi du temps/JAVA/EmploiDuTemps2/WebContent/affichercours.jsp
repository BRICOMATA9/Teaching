...
listAllModule = service.findModuleByClasseAndPromotion(string1, string2);
%>
        ...
        <tr>
          ...
          <td colspan="2"><table width="1111" border="1" bordercolor="#666666">
            <tr>
              ...
              <td width="410" bgcolor="#0066FF"><span class="Style12">Professors</span></td>
             </tr>
          ...
          <td width="63" bgcolor="#0066FF"><span class="Style12"><% 
              ...
              %></span></td>
          <td width="410" bgcolor="#0066FF"><span class="Style12"><a href="voircours.jsp?idModule=<%=module.getId()%>"><% 
            	 out.print( module.getName());
              %></a></span></td>
              <%Professor professor = new Professor();
        		professor = service.findProfessorById(module.getIdProfessor()); %>
          <td width="410" bgcolor="#0066FF"><span class="Style12"><a href="voirprofessors.jsp?idProfessor=<%=professor.getId()%>"><% 
            	out.print( professor.getFirstName() + professor.getLastName());
              %></a></span></td>
              </tr>
                <% }%>
