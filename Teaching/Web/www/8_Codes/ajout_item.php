...
<head>
    ...
    <title>Ajout Item | ECE Amazon</title>
    <meta charset="utf-8">
...
<body>
    ...
    <header>
        <div class="container">
            <!-- Titre -->
            <h2 class="titre">Mettre en vente un produit</h2>
            <!-- Bouton retour -->
            ...
            <!-- Choix du produit à vendre -->
            <h6 style="text-align:center;padding:30px 0px 30px 0px">Veuillez choisir la catégorie du produit à vendre</h6>
            <!-- Découpage de la page en grille -->
            <div class="row" style="padding-bottom:30px">   
                <div class="col-lg-3 col-md-3 col-sm-12">
                     <a class="lien" href="ajout_item_livre.php"><button style="background-color:#F6745A;border:grey" type="button" class="btn btn-secondary btn-block">Livres</button></a>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-12">
                    <a class="lien" href="ajout_item_musique.php"><button style="background-color:#F6745A;border:grey" type="button" class="btn btn-secondary btn-block">Musique</button></a>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-12">
                    <a class="lien" href="ajout_item_vetement.php"><button style="background-color:#F6745A;border:grey" type="button" class="btn btn-secondary btn-block">Vêtements</button></a>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-12">
                    <a class="lien" href="ajout_item_sportloisir.php"><button style="background-color:#F6745A;border:grey" type="button" class="btn btn-secondary btn-block">Sports et Loisir</button></a>
                </div>
            </div>
        </div>
    </header>
