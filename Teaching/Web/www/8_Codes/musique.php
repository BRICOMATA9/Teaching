...
<head>
    ...
    <title>Musique | ECE Amazon</title>
    <meta charset="utf-8">
        ...
        <div class="container-fluid">
                ...
                <div class="col-md-2">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="list-group" id="list-group" aria-labelledby="navbarDropdown2">
                            <a style="color:#f6745a" class="list-group-item" href="musique.php?click0=1" clicked>Tout voir</a><br>
                            <a class="nav-item dropdown-toggle" id="navbarDropdown2" role="button" data-toggle="dropdown">Genre</a>
                                <div class="list-group" id="list-group" aria-labelledby="navbarDropdown2">
                                    <a style="color:#f6745a" class="list-group-item" href="musique.php?click1=1" >House</a>
                                    <a style="color:#f6745a" class="list-group-item" href="musique.php?click2=1" >Pop</a>
                                    <a style="color:#f6745a" class="list-group-item" href="musique.php?click3=1" >Rap</a>
                                    <a style="color:#f6745a" class="list-group-item" href="musique.php?click4=1" >Rock</a>
                                    <a style="color:#f6745a" class="list-group-item" href="musique.php?click5=1" >Variété Française</a>
                                </div><br>
                        </div>
                    </li>
                </ul>
            ...
            <div class="col-md-10">
                ...
                <!-- Affichage de la bannière -->
                    <img src="musique.jpg" alt="Musique" class="img-fluid">
                </div>
                <br><br>
                <div class="row">
                <?php
                    //recherche tous les albums
                    ...
                    $result = mysqli_query($db_handle, $sql);
                            ...
                            while($data = mysqli_fetch_array($result)){
                                ...
                                echo '<ul class="social">
                                        ...
                                        <li><a href="redirection_musique.php" data-tip="Quick view"><i class="fa fa-search"></i></a></li>
                                    </ul>';
                                echo '</div>';
                    ...
                    //recherche les albums house music
                    
                    if (isset($_GET["click1"])) {
                    $sql = "SELECT *FROM musique WHERE genre= 'house music' " ;
                    $result = mysqli_query($db_handle, $sql);
                            while($data = mysqli_fetch_array($result)){
                                //Affichage de l'image des produits
                    ...
                    //recherche les albums pop

                    if (isset($_GET["click2"])) {
                    $sql = "SELECT *FROM musique WHERE genre= 'pop' " ;
                    $result = mysqli_query($db_handle, $sql);
                    ...
                    //recherche les albums de rap

                    if (isset($_GET["click3"])) {
                    $sql = "SELECT *FROM musique WHERE genre= 'rap' " ;
                    $result = mysqli_query($db_handle, $sql);
                    ...
                    //recherche les albums de rock

                    if (isset($_GET["click4"])) {
                    $sql = "SELECT *FROM musique WHERE genre= 'rock' " ;
                    $result = mysqli_query($db_handle, $sql);
                    ...
                    //recherche les albums de variété française

                    if (isset($_GET["click5"])) {
                    $sql = "SELECT *FROM musique WHERE genre= 'variete' " ;
                    $result = mysqli_query($db_handle, $sql);
