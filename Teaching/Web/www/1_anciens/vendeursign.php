		...
		//recuperer les donnees venant de la page HTML
 				...
 				if ($_POST["button2"])
 			{
 				if($db_found){
 					...
 					$result = mysqli_query($db_handle, "SELECT * FROM vendeur WHERE Email LIKE '%$email%'");
 					...
 					while ($data = mysqli_fetch_assoc($result)){
						...
						echo "Votre Pseudo: " . $data['pseudo'] . "<br>";
						echo "<br>";
						}
...
<ul>
	<li>
		<a href="form_choix.php">Ajouter un produit</a>
	</li>
	<li>
		<a href="supp-produit.html">Supprimer un produit</a>
	</li>
</ul>
