...
<html lang="fr">
<head>
	<title>Joyeux St-Valentin</title>
	<meta charset="UTF-8">
...
<!-- Title page -->
	<section class="bg-img1 txt-center p-lr-15 p-tb-92" style="background-image: url('images/rouge.jpg');">
		<h2 class="ltext-105 cl0 txt-center">
			Joyeux St-Valentin <3
		</h2>
	</section>
		...
		<div class="container">
			<div class="p-b-10">
				<h3 class="ltext-103 cl5">
					-30% sur la collection femmes <br>
				</h3>

				<h4>
					Faites plaisir à votre chérie
				</h4>
			</div>
			...
			<div class="row isotope-grid">
                ...
                if ($db_found) {
                 $sql = "SELECT * FROM items WHERE categorie ='8' ";
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								...
								<span class="stext-105 cl3">
									<s><?php echo  $data['prix'],'€'; ?></s>
								</span>
								<span class="stext-105 cl3">
									<?php echo  $data['prix']*0.7 ,'€'; ?>
								</span>
							</div>
