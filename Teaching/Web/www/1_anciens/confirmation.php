	...
	<section class="bg0 p-t-104 p-b-116">
		...
		<?php	 
			...
			$prenom = isset($_POST["prenom"])?$_POST["prenom"] : "";
 			...
 			if($adresse1 == "") {$erreur .= "Le champ Adresse ligne 1 est vide. <br>";}
 			
 			if($Ville == "") {$erreur .= "Le champ Ville est vide. <br>";}
 			if($code == "") {$erreur .= "Le champ code postale est vide. <br>";}
 			if($num == "") {$erreur .= "Le champ Numero de telephone est vide. <br>";}
 			if($numc == "") {$erreur .= "Le champ Numero de la carte est vide. <br>";}
 			if($holder == "") {$erreur .= "Le champ Nom affiché sur la carte est vide. <br>";}
 			if($date == "") {$erreur .= "Le champ date d'expiration est vide. <br>";}
 			if($codesecu == "") {$erreur .= "Le champ code de securité est vide. <br>";}
 			...
 			if ($erreur == "") {
 				...
 				echo "Votre commande est bien passée. <br> Vous allez la recevoir dans un délai de 10 jours ouvrables.";
 			...
 			{
 				echo "Erreur : $erreur";
 				echo "Vous devez remplir tout les champs. <br>";
 			}
