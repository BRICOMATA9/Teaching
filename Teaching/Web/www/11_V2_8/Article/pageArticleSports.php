...
<main role="main">
	...
	<!-- A LIRE !!!!!!!!! https://openclassrooms.com/fr/courses/918836-concevez-votre-site-web-avec-php-et-mysql/914293-lisez-des-donnees -->
			...
			<?php
				...
				$reponse = $bdd->query('SELECT * FROM items INNER JOIN sports_hobbies ON items.id=sports_hobbies.id_item WHERE id='.$_GET['id']);
			...
			?>
				...
				<div id="pageArticle">
						...
						<div id="bouton_retour" class = "container">
							<a class="btn btn-link" id="bouton_retour" href="../categorie/sports_loisirs.php" role="button"><< Retour page Sports & Loisirs</a>
						</div>
					...
					<div id="pict">
						...
						<div id="partiePhoto">
							<input id="photo" type="image" src='../photoPiscine/Sport/<?php echo $photoDeItem; ?>' height='400em' width=auto>
						</div>
					...
					<div id="info">
						...
						<br><h3>Information de l'objet :</h3>

						<table>

						<tr>
						<td>Idéal pour le <?php echo $donnees['type']; ?></td>
						</tr>
