...
<head>
  ...
  <title>Produits en vente</title><!--Titre barre de navigation internet-->
  ...
  <header>  <!-- tete de notre site -->
    ...
    <section class="jumbotron text-center">
      ...
      <div class="py-5 text-center text-info">
        <h2>Vos articles en vente</h2>
        <p class="lead">Vous êtes vendeur chez A MA ZONE ? Voici tous les articles que vous avez mis en vente ! </p>
      </div>
    </section>
...
if ($db_found) {
  ...
  <h6>".$data['Prix']."€ </h6>
  <p class='card-text'> Quantité en Stock : ".$data['Stock']."x </p>                
  <form method= 'POST' action = 'cart.php?id=".$data["Id"]."&action=supprimeritems'> 
  <input type= 'submit' class='float-right btn btn-dark btn-sm' value='Supprimer article' name = 'supprimeritems' ></input> </br>
  </form>
...
<footer class="my-5 pt-5 text-muted text-center text-small">
  ...
  <p>Ou nous retrouver? Visiter notre<a href="https://www.facebook.com/A-MA-ZONE-2302826419965406/"> Facebook</a> ou notre page <a href="https://www.instagram.com/amazoneece/?hl=fr">Instagram</a>.</p> <!--lien qui remonte en haut de la page -->
</footer>
