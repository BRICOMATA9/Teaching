		...
		<a class="nav-link" href = "accueil.html"><img class="Eceamazon" src="images/logo.jpg" alt="plsthumb" width="80" height="80"><br>  
		 ...
		 <div class="collapse navbar-collapse" id="main-navigation">
			 <ul class="navbar-nav">
		    	 ...
		    	 <li class="nav-item"><a class="nav-link" href = "moyenpaiement.html"><img  width="50" height="50" src="images/store.png"></a>
		    	</li>
			 </ul>
		 </div>
	</nav>
	...
	<form id="<?php if ($cree == 1) { echo "hideform";} else { echo "shoform";} ?>" action="creercompte.php" method="post">
		...
		<table>
			...
			<tr>    
				...
				<td>
					<?php 
						if($phone == "") { echo "Veuillez remplir le champ 'Téléphone'. <br>"; } 
					?>
				</td> 
			</tr>
			<tr>   
				...
				<td>
					<?php 
						if($adresse == "") { echo "Veuillez remplir le champ 'Adresse'. <br>"; } 
			...
			<tr>   
				...
				<td>
					<?php 
						if($pays == "") { echo "Veuillez remplir le champ 'Pays'. <br>"; }
