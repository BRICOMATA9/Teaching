...
<body>
	<main role="main">
		...
		<div class="jumbotron">
			<div class="container">
			  <h1 class="display-3">Musiques</h1>
			  <p>Achetez vos CD et Vinyles parmi plus d'1 million d'articles : Rap/Hip-Hop, Rock, Jazz, Pop, BO, Blues, Reggae, R&B, Electro... <br>Dans cette e-boutique, nous nous efforçons de vous proposer les meilleurs articles aux meilleurs prix ! </p>
			</div>
		</div>
		...
		<div class="container">
			...
			<div id="all_blocks">
				...
				$reponse = $bdd->query('SELECT * FROM items INNER JOIN music ON items.id=music.id_item');	
					...
					<div class="col-md-4" id="itemAff">
						<p>
							...
							<div id="block_bouton" class = "container">
								<a class="btn btn-warning" id="bouton_annonce" href="../Article/pageArticleMusic.php?id=<?php echo $donnees['id'] ?>" role="button">Voir l'offre &raquo;</a>
							</div>
						</p>
					</div>
