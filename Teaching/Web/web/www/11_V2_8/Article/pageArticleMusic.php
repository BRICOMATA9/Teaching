...
<main role="main">
	...
	<!-- A LIRE !!!!!!!!! https://openclassrooms.com/fr/courses/918836-concevez-votre-site-web-avec-php-et-mysql/914293-lisez-des-donnees -->
			...
			<?php
				...
				$reponse = $bdd->query('SELECT * FROM items INNER JOIN music ON items.id=music.id_item WHERE id='.$_GET['id']);
			...
			?>
				...
				<div id="pageArticle">
						...
						<div id="bouton_retour" class = "container">
							<a class="btn btn-link" id="bouton_retour" href="../categorie/musiques.php" role="button"><< Retour page Musiques</a>
						</div>
					...
					<div id="pict">
						...
						<h4><?php echo $donnees['artist']; ?></h4><br>
						<div id="partiePhoto">
							<input id="photo" type="image" src='../photoPiscine/Musique/<?php echo $photoDeItem; ?>' height='400em' width=auto>
						</div>
					...
					<div id="info">
						...
						<br><h3>Information de l'article :</h3>
