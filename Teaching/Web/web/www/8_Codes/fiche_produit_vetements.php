                ...
                <div class="col-lg-8 col-md-8 col-sm-12" id="carrousel"> 
                        ...
                        <?php
                            ...
                            while($data = mysqli_fetch_assoc($result)){
                                ...
                                if($data['video'] != ""){
                                    print '<li><center><iframe class="img" src="'.$data['video'].'height="350px"></iframe></center></li>';
                                }
                                echo '</ul>';
                        ?>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12" id="infos">
                        ...
                        <?php
                            ...
                            while($data = mysqli_fetch_assoc($result)){
                                ...
                                echo "<br><em>Pour " . $data['genre'] . '</em><br>';
                                echo "<br>Couleur: " . $data['couleur'] . '<br>';  
                        ...
                        ?>
                    <!-- formulaire pour récupérerla quantité -->
                    <form method="post">
                        <tr>
                            <td>Quantité: </td>
