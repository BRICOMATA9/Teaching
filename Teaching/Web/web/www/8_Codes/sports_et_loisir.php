...
<head>
    ...
    <title>Sports et Loisir | ECE Amazon</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" type="text/css" href="sports_et_loisir.css">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-2">
                    ...
                    <div class="list-group" id="list-group" aria-labelledby="navbarDropdown2">
                        <a style="color:#f6745a" class="list-group-item" href="sports_et_loisir.php?click0=1" clicked>Tout voir</a><br>
                        <a class="nav-link dropdown-toggle" id="navbarDropdown2" role="button" data-toggle="dropdown">Activité</a>
                            <div class="list-group" id="list-group" aria-labelledby="navbarDropdown2">
                                <a style="color:#f6745a" class="list-group-item" href="sports_et_loisir.php?click=1" >Attraction</a>
                                <a style="color:#f6745a" class="list-group-item" href="sports_et_loisir.php?click1=1" >Culturelle</a>
                                <a style="color:#f6745a" class="list-group-item" href="sports_et_loisir.php?click2=1" >Détente</a>
                                <a style="color:#f6745a" class="list-group-item" href="sports_et_loisir.php?click3=1" >Plein Air</a>
                                <a style="color:#f6745a" class="list-group-item" href="sports_et_loisir.php?click4=1" >Sportive</a>
                            </div><br>
                        <a class="nav-link dropdown-toggle" id="navbarDropdown2" role="button" data-toggle="dropdown">Age</a>
                            <div class="list-group" id="list-group" aria-labelledby="navbarDropdown2">
                                <a style="color:#f6745a" class="list-group-item" href="sports_et_loisir.php?click5=1" >Moins de 4 ans</a>
                                <a style="color:#f6745a" class="list-group-item" href="sports_et_loisir.php?click6=1" >Moins de 10 ans</a>
                                <a style="color:#f6745a" class="list-group-item" href="sports_et_loisir.php?click7=1" >Moins de 12 ans</a>
                                <a style="color:#f6745a" class="list-group-item" href="sports_et_loisir.php?click8=1" >Moins de 16 ans</a>
                                <a style="color:#f6745a" class="list-group-item" href="sports_et_loisir.php?click9=1" >Moins de 18 ans</a>
                            </div><br>
                    </div>
                    </li>
                    </ul>
            ...
            <div class="col-md-10">
                ...
                <!-- Affichage de la bannière -->
                    <img src="sports_et_loisir.jpg" alt="Sports et Loisir" class="img-fluid">
                </div>
                </br></br>
                <div class="row">
                <?php
                    
                    //recherche tous les  activités de parc d'attraction
                    
                    if (isset($_GET["click0"])) {
                    $sql = "SELECT * FROM `sports_loisir`";
                    $result = mysqli_query($db_handle, $sql);
                ...
                <?php
                    ...
                    if (isset($_GET["click"])) {
                    $sql = "SELECT * FROM `sports_loisir` WHERE activite= 'Parc attractions' ";
                    $result = mysqli_query($db_handle, $sql);
                ...
                <?php
                    ...
                    //recherche tous les sorties culturelles
                    
                    if (isset($_GET["click1"])) {
                    $sql = "SELECT * FROM `sports_loisir` WHERE activite='Sortie culturelle'" ;
                    $result = mysqli_query($db_handle, $sql);
                ...
                ?>
                <?php
                    //recherche toutes les activités de détente

                    if (isset($_GET["click2"])) {
                    $sql = "SELECT * FROM `sports_loisir` WHERE activite='Detente' " ;
                    $result = mysqli_query($db_handle, $sql);
                ...
                <?php
                    //recherche tous les activités de pleins air

                    if (isset($_GET["click3"])) {
                    $sql = "SELECT * FROM `sports_loisir` WHERE activite='Plein air'" ;
                    $result = mysqli_query($db_handle, $sql);
                ...
                <?php
                    //recherche les activités sportives

                    if (isset($_GET["click4"])) {
                    $sql = "SELECT * FROM `sports_loisir` WHERE activite='Sport'" ;
                    $result = mysqli_query($db_handle, $sql);
                ...
                <?php
                    //recherche les activités pour les moins de 4 ans

                    if (isset($_GET["click5"])) {
                    $sql = "SELECT * FROM `sports_loisir` WHERE age <= '4'" ;
                    $result = mysqli_query($db_handle, $sql);
                ...
                <?php
                    //recherche tous les activités pour les moins de 10ans

                    if (isset($_GET["click6"])) {
                    $sql = "SELECT * FROM `sports_loisir` WHERE age <= '10'" ;
                    $result = mysqli_query($db_handle, $sql);
                ...
                <?php
                    //recherche tous les activités pour les moins de 12 ans

                    if (isset($_GET["click7"])) {
                    $sql = "SELECT * FROM `sports_loisir` WHERE age <= '12'" ;
                    $result = mysqli_query($db_handle, $sql);
                ...
                <?php
                    //recherche tous les activités pour les moins de 16 ans

                    if (isset($_GET["click8"])) {
                    $sql = "SELECT * FROM `sports_loisir` WHERE age <= '16'" ;
                    $result = mysqli_query($db_handle, $sql);
                ...
                <?php
                    //recherche tous les activités pour les moins de 18 ans

                    if (isset($_GET["click9"])) {
                    $sql = "SELECT * FROM `sports_loisir` WHERE age <= '18'" ;
                    $result = mysqli_query($db_handle, $sql);
