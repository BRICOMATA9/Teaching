...
<!-- Title page -->
	<section class="bg-img1 txt-center p-lr-15 p-tb-92" style="background-image: url('images/noel.jpg');">
		...
		<div class="container">
			<div class="p-b-10">
				<h3 class="ltext-103 cl5">
					<br>-50% sur Tout nos produits
				</h3>

				<h4>
					<br>Faites-vous plaisir
				</h4>
			</div>
